...
Deep neural networks have gained much popularity in a wide range of computer vision tasks, from low-level tasks, such as image denoising and sharpening, to mid-level tasks, such as keypoint detection, to high-level tasks, such as object recognition.
